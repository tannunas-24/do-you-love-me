...
<style>
  * {
  ...
  #bodyblur{opacity:.15;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.5);transition:all 1s ease;} 
  ...
  .swiper-slide {text-align: center;font-size: 18px;display: flex;flex-direction: column;justify-content: center;align-items: center;margin-top:-100px;}
  ...
  .swal2-modal{background: rgba(0,0,0, 1);backdrop-filter: blur(0);-webkit-backdrop-filter: blur(0);box-shadow: 0 4px 30px rgba(255,255,255, 0.3);border: 1px solid rgba(255, 255, 255, 1);border-radius: 12px;max-width:325px;top:-60px;}
...
<body>
  <audio src="./assets/foreveryoung.mp3" id="linkmp3" class="sembunyi"></audio>
  <div class="overlay">
    <div class="loading-message">Hey you!<br>Please wait...</div>
  ...
  <div id="bodyblur">
    <img src="./assets/wp2.jpeg" id="wallpaper"/>
    <div id="thisblur"></div>
  </div>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        ...
        <h1 id="teks1" class="scale0 quicksand" style="font-size: 20px;">
          Helloo You 🫢<br><br> >>>>
        </h1>
      </div>
      ...
      <div class="swiper-slide">
        <div id="stiker2" class="scale0 stiker">
          <img id="stikerDuaDef" src="./assets/hearthappy.gif" />
          <img id="stikerDua1" class="sembunyi" src="./assets/smprt.gif" />
          <img id="stikerDua2" class="sembunyi" src="./assets/pusn.gif" />
          <img id="stikerDua3" class="sembunyi" src="./assets/ngumpet.gif" />
        </div>
        <h1 id="teks2" class="scale0 quicksand" style="font-size: 19px;">
          Do you love me? 🫣
        </h1>
        <div id="Tombol" style="opacity:0;transform: scale(0)">
          <a id="By" onClick="swiper.slideNext();">Love</a>
          <a id="Bn" onClick="btn='Bn';fungsibaru(btn)">No</a>
        </div>
        <!-- Text when clicking "No" -->
        <div id="teksTolakGroup" class="sembunyi">
          <p id="teksTolak">Oh, why like that 😡</p>
          <p id="teksTolak2">Are you sure you don't love me? 🥹</p>
          <p id="teksTolak3">Please 🥲</p>
        </div>
      </div>

      <div class="swiper-slide">
        <div id="stiker3" class="scale0 stiker" style="margin-top:50px">
          <img id="stikerAkhir1" src="./assets/cilukba.gif" />
          <img id="stikerAkhir2" class="sembunyi" src="./assets/pandapanah.gif" />
          <img id="stikerAkhir3" class="sembunyi" src="./assets/emawh.gif" />
        </div>
        <div id="scroll-container" class="blocktext">
          <h1 id="teks3" class="scale0 quicksand" style="font-size: 17px;font-weight:400">
            <span id="subteks2a">
              <b>Waaa...</b> Anyway, I don't want to know,<br>
              you must love me!! 😝
            </span>
            <span id="subteks2b">
              <b>Because... 🫣💐</b>
          ...
          <h1 id="teksTerakhir" class="sembunyi">
            I loooove <b>loveee loveee<br>loveee</b> sooo sooo much<br>youuuu!!!<br>🥹🥹💞💞🫶🫶🫶
          </h1>
          <h1 id="teksTambahan" class="sembunyi">
            <span id="teksLove">Iloveyouuuu</span>
          </h1>
          <script>
            const loveEmojis = ['💙','🩷','❤️','💜','🧡'];
          </script>
  ...
  <script>
    ...
    function katanimasi(){
      teks3.innerHTML = "";
      new TypeIt("#teks3", {
        strings: ["" + varsubteks2a, "<br><br>" + varsubteks2b],
        startDelay: 1,
        speed: 27,
        cursor: true,
        breakLines: true,
        ...
        afterStep: function(instance) {
          if (instance.is('completed')) {
            setTimeout(function() { instance.next(); }, 1500);
          }
        },
    ...
    function katanimasi3(){
      ...
      new TypeIt("#teks3", {
        strings: Array.from({length: 10}, (_, i) => `Iloveyouuuu ${i + 1}% ${ambilRandomEmoji}`),
        startDelay: 1,
        speed: 0.2,
        cursor: false,
        nextStringDelay: 0,
    ...
    var loveBlock = document.querySelector(".blocklove");
